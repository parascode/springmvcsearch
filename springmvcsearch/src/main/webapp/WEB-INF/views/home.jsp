...
<script src="<c:url value="/resources/js/script.js"></c:url>" type="text/javascript"></script>
...
<body>
	<div class="container ">
		...
		<div class="card mx-auto mt-5 bg-secondary" style="width: 50%;">
			<div class="card-body">
		<img alt="photo" class="img-thumbnail" src="<c:url value="/resources/image/search.jpg"/>">
